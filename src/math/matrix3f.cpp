...
Matrix3f::Matrix3f() : m00(0), m01(0), m02(0), m10(0), m11(0), m12(0), m20(0), m21(0), m22(0) {}
...
Vector3f* Matrix3f::mult(const Vector3f& other) {
  return new Vector3f(m00 * other.x + m01 * other.y + m02 * other.z,
...
Matrix3f* Matrix3f::inv() {
  ...
  Matrix3f* mat = new Matrix3f(m11 * m22 - m12 * m21, m02 * m21 - m01 * m22, m01 * m12 - m02 * m11,
