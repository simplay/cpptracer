...
const Axis::Label& BspNode::getAxis() const {
  return axis;
}

const BspNode* BspNode::getAbove() const {
  return above;
}

const BspNode* BspNode::getBelow() const {
  return below;
}

float BspNode::getPlanePositionParam() const {
